...
@interface ECLoginBindPhoneController ()
{
...
@implementation ECLoginBindPhoneController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self.sumbit setBackgroundColor:ECColorWithHEX(0x888888) forState:UIControlStateHighlighted];
}
