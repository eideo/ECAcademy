...
#define kDefaultColor [UIColor colorWithRed:22.f / 255.f green:126.f / 255.f blue:251.f / 255.f alpha:1.0]
...
-(void)configureViews
{
    ...
    UIColor *tintColor =  kECBlackColor3;//kECBlueColor; // iOS7 Safari bar color
